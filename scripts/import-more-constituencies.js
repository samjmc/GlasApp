/**
 * Script to import more constituencies with accurate 2024 Irish General Election results
 */
...
const constituencyData = [
  ...
  },
  {
    ...
    totalVotes: 61562,
    results: [
      { party: "Fianna Fáil", percentage: 24.6, seats: 1, color: "#01954B" },
      { party: "Sinn Féin", percentage: 21.8, seats: 1, color: "#326760" },
      { party: "Fine Gael", percentage: 18.4, seats: 1, color: "#0087DC" },
      { party: "Independent", percentage: 26.1, seats: 1, color: "#808080" },
      { party: "Labour Party", percentage: 1.4, seats: 0, color: "#E4003B" },
      { party: "Green Party", percentage: 2.8, seats: 0, color: "#6AB023" },
  ...
  },
  {
    ...
    totalVotes: 70014,
    results: [
      { party: "Fianna Fáil", percentage: 19.0, seats: 1, color: "#01954B" },
      { party: "Sinn Féin", percentage: 15.9, seats: 1, color: "#326760" },
      { party: "Fine Gael", percentage: 16.1, seats: 1, color: "#0087DC" },
      { party: "Independent", percentage: 42.3, seats: 2, color: "#808080" },
      { party: "Labour Party", percentage: 0.7, seats: 0, color: "#E4003B" },
      { party: "Green Party", percentage: 1.6, seats: 0, color: "#6AB023" },
      { party: "People Before Profit", percentage: 0.6, seats: 0, color: "#8B0000" },
      { party: "Aontú", percentage: 2.8, seats: 0, color: "#44532A" },
      { party: "Other", percentage: 1.0, seats: 0, color: "#CCCCCC" }
    ]
  },
  {
    ...
    totalVotes: 59378,
    results: [
      { party: "Sinn Féin", percentage: 20.3, seats: 1, color: "#326760" },
      { party: "Fianna Fáil", percentage: 13.8, seats: 1, color: "#01954B" },
      { party: "Fine Gael", percentage: 15.9, seats: 1, color: "#0087DC" },
      { party: "Independent", percentage: 25.7, seats: 1, color: "#808080" },
      { party: "Labour Party", percentage: 4.5, seats: 0, color: "#E4003B" },
      { party: "Green Party", percentage: 6.9, seats: 0, color: "#6AB023" },
      { party: "People Before Profit", percentage: 4.2, seats: 0, color: "#8B0000" },
      { party: "Aontú", percentage: 2.9, seats: 0, color: "#44532A" },
      { party: "Other", percentage: 5.8, seats: 0, color: "#CCCCCC" }
    ]
  },
  {
    ...
    results: [
      ...
      { party: "Sinn Féin", percentage: 19.1, seats: 1, color: "#326760" },
      { party: "Fine Gael", percentage: 16.0, seats: 1, color: "#0087DC" },
      { party: "Labour Party", percentage: 11.5, seats: 1, color: "#E4003B" },
      { party: "Social Democrats", percentage: 2.6, seats: 0, color: "#752F8B" },
      { party: "Independent Ireland", percentage: 5.8, seats: 0, color: "#F5F5DC" },
      { party: "Green Party", percentage: 3.3, seats: 0, color: "#6AB023" },
      { party: "People Before Profit", percentage: 1.6, seats: 0, color: "#8B0000" },
      { party: "Aontú", percentage: 4.5, seats: 0, color: "#44532A" },
      { party: "Independent", percentage: 8.5, seats: 0, color: "#808080" }
    ]
  },
  {
...
async function importMoreConstituencies() {
  try {
    console.log("Starting import of more constituency data...");
    ...
    console.log("Finished importing more constituency data!");
  } catch (error) {
...
importMoreConstituencies().catch(console.error);