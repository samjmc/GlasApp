...
// Set the constituency to update
const constituencyName = "Cork South-Central";
 ...
 */
async function getWikipediaResults() {
 ...
 */
async function updateConstituencyWithWikipedia() {
  try {
    // Get the file path
    ...
    const wikiData = await getWikipediaResults();
