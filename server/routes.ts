...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.use("/api/shadow", requireAdminOrCron, shadowRoutes); // The Shadow Cabinet
  ...
  app.use("/api/admin/news-scraper", requireAdminOrCron, newsScraperRoutes);
  app.use("/api/admin/parliamentary", requireAdminOrCron, parliamentaryAdminRoutes);
  app.use("/api/admin/debates", requireAdminOrCron, debateAdminRoutes);
  app.use("/api/admin/baselines", requireAdminOrCron, baselineAdminRoutes);
  app.use("/api/admin/articles", requireAdminOrCron, manualArticleRoutes);
  app.use("/api/admin/td-scoring", requireAdminOrCron, tdScoringAdminRoutes);
