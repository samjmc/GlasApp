...
ALTER TABLE "politics"."td_parliament_stats" ADD COLUMN "divisions_in_office" integer;--> statement-breakpoint
...
CREATE INDEX "td_offices_td_idx" ON "politics"."td_offices" USING btree ("td_id");